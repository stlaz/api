...
func (in *ConsoleQuickStartTask) DeepCopyInto(out *ConsoleQuickStartTask) {
	*out = *in
	...
	if in.Recapitulation != nil {
		in, out := &in.Recapitulation, &out.Recapitulation
		*out = new(ConsoleQuickStartTaskRecapitulation)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConsoleQuickStartTaskRecapitulation) DeepCopyInto(out *ConsoleQuickStartTaskRecapitulation) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConsoleQuickStartTaskRecapitulation.
func (in *ConsoleQuickStartTaskRecapitulation) DeepCopy() *ConsoleQuickStartTaskRecapitulation {
	if in == nil {
		return nil
	}
	out := new(ConsoleQuickStartTaskRecapitulation)
